...
- `src/Workers/Tagger/RuleEngine`: supporting types that build rule contexts, wire up rule sets to integration events, and apply outputs without being mixed into the rule definitions themselves.
