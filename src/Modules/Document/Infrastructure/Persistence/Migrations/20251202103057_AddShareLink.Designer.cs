...
namespace ECM.Document.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20251202103057_AddShareLink")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ECM.Document.Infrastructure.Persistence.Models.ShareAccessEventEntity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("ECM.Document.Infrastructure.Persistence.Models.ShareLinkEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("ECM.Document.Infrastructure.Persistence.Models.ShareStatisticsView", b =>
                {
            ...
            modelBuilder.Entity("ECM.Document.Infrastructure.Persistence.Models.ShareAccessEventEntity", b =>
                {
                    b.HasOne("ECM.Document.Infrastructure.Persistence.Models.ShareLinkEntity", "Share")
                        .WithMany()
