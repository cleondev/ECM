...
public static class Program
{
    ...
    public static void Main(string[] args)
    {
        ...
        var ecmHost = builder.AddProject<Projects.ECM_Host>("ecm")
            .WithReference(kafka)
            .WithReference(minio)
            .WithHttpEndpoint(targetPort: ecmUri.Port, port: ecmUri.Port, name: "ecm-http", isProxied: false)
        ...
        builder.AddProject<Projects.AppGateway_Api>("app-gateway")
            ...
            .WithHttpEndpoint(targetPort: gatewayUri.Port, port: gatewayUri.Port, name: "app-gateway-http", isProxied: false)
