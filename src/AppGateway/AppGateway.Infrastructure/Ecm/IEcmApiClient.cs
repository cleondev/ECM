...
public interface IUsersApiClient
{
    ...
    Task<UserSummaryDto?> AuthenticateUserAsync(AuthenticateUserRequestDto requestDto, CancellationToken cancellationToken = default);
...
public interface IRelationsApiClient
{
...
public interface IDocumentsApiClient
{
    ...
    Task<DocumentDto?> UpdateDocumentAsync(Guid documentId, UpdateDocumentRequestDto requestDto, CancellationToken cancellationToken = default);
...
public interface IWorkflowsApiClient
{
...
public interface ISignaturesApiClient
{
