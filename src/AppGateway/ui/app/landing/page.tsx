    ...
    <div className="landing-theme min-h-screen bg-background">
      ...
      <section id="features" className="border-b border-border/40 stars-bg cosmic-glow">
        <div className="container mx-auto px-4 lg:px-8 py-20 sm:py-28 relative z-10">
          <div className="max-w-3xl mb-16 sm:mb-20 animate-slide-up">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              <Card
                key={i}
                className="p-6 sm:p-8 bg-card/50 backdrop-blur-sm border-border hover:border-primary/50 hover:shadow-2xl hover:shadow-primary/20 hover:scale-105 transition-all duration-500 animate-fade-in float-animation"
                style={{ animationDelay: `${i * 0.15}s` }}
              >
                <feature.icon className="h-10 w-10 sm:h-12 sm:w-12 text-primary mb-6 transition-transform group-hover:scale-110" />
        ...
        <div className="container mx-auto px-4 lg:px-8 py-20 sm:py-28 relative z-10">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            <div className="animate-slide-up">
              <h2 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-foreground mb-6 sm:mb-8 text-balance">
              ...
              <Button
                size="lg"
                className="mt-8 sm:mt-10 w-full sm:w-auto bg-primary text-primary-foreground hover:bg-primary/90 hover:scale-105 sm:hover:scale-110 hover:shadow-2xl hover:shadow-primary/50 transition-all shimmer"
              >
                Explore Solutions
                <ArrowRight className="ml-2 h-5 w-5" />
              </Button>
            ...
            <div className="relative animate-scale-in">
              <Card className="p-6 sm:p-8 lg:p-10 bg-card/50 backdrop-blur-sm border-border hover:shadow-2xl hover:shadow-primary/20 transition-all duration-500 float-animation">
                <div className="space-y-4 sm:space-y-6">
                  {[
                    ...
                    <div
                      key={i}
                      className="flex items-center gap-4 sm:gap-5 p-4 sm:p-5 bg-secondary/30 backdrop-blur-sm rounded-xl hover:bg-secondary/50 hover:scale-105 transition-all duration-300 border border-border/30"
                      style={{ animationDelay: `${i * 0.15}s` }}
                    >
